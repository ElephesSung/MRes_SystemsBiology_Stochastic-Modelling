...
cycle = input("How many sets of figures do you want? ")
for i in range(cycle):
    ...
    fano = np.mean(mRNA_level_SS)/np.var(mRNA_level_SS)
    ...
    fano_P = np.mean(Protein_level_SS)/np.var(Protein_level_SS)
